        ...
        var body: some View {
            NavigationStack {
                List {
                    ...
                    Section("Evidence") {
                        Text(
                            "Lock the screen for five minutes while music plays. Disconnect and reconnect the supported headphone route while stationary. Trigger one interruption, then verify explicit resume."
                        )
