...
- Commit `67adf80` was built for the phone with exact profile `Samadhi Development 2026-08-15`, which expires August 15, 2027, installed in place on 2026-08-19, and read back on the device: in-app source fingerprint `8df37f8dca11dfa0ad38346b2ea2339a5d76c9a10c4a539b471d8a1ea7df02e6`. The glass transport and catalog tie fix that followed it on the same day pass the same gate and were installed in place as commit `13e88bf` with built fingerprint `085e5fe7b0e080a19efe281bd69fa5ebaeab00e0d082bc64701cd03d98de4f82`; the phone was locked, so that build has no in-app read-back yet. At that install the selected playlist on the phone held 25 songs with 11 unmatched by the old tie rule, and it must be chosen again in the app for them to resolve.
