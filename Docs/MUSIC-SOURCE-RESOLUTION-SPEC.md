...
1. Run the restored 13-ready-track collection through a real track transition and confirm cadence, applied-rate behavior, and the saved diagnostic file.
2. Complete Bluetooth listening, five locked minutes, controlled interruption, and route loss before Milestone 2 completion.
