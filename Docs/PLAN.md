...
- Device evidence: setup-craft commit `0a59b64` is installed with the selected collection preserved; foreground launch confirmation remains open because the phone was locked
