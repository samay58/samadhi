...
- Automated body-to-music gate: 103 package tests, 15 app-model tests, 10 UI tests, formatter, normal Simulator build, focused rotary-control UI proof, and runtime screen review pass; the expired exact profile must be renewed before installation
