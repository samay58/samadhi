...
| F-015 transport and finish craft | Complete in software; physical feel open | The three pills became one glass capsule bar, which read as a slab on the phone and was replaced on 2026-08-19 by three separate interactive glass circles with a larger tinted primary (`Evidence/Simulator/2026-08-19-transport-glass/`); Finish is a quiet hold whose fill is clipped by its own capsule. Both reported overflow causes were reproduced on 30 fps video and are gone from the after frames in `Evidence/Simulator/2026-08-18-transport-finish/`. Press feel, haptic character, and daylight legibility remain physical. |
