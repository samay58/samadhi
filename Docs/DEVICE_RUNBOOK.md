...
A valid development signing identity is installed. No physical iPhone was connected during Milestones 0 and 1.

## Future physical-device check
...
Physical cadence and audio quality are outside Milestone 1. Simulator evidence must never be described as a real-run result.
